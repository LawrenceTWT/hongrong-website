(() => {
  ...
  const zh = {
    ...
    modelSourceCaption: "六個交通等級，全部來自真實道路攝影機畫面。",
    modelLevel1: "非常通暢",
    modelLevel2: "順暢",
    modelLevel3: "一般",
    modelLevel4: "擁擠",
    modelLevel5: "嚴重擁擠",
    modelLevel6: "堵塞",
    modelPredictionCaption: "驗證樣本直接顯示真實類別與模型預測，也看得見相鄰等級的混淆。",
    modelCurveCaption: "各類別 AP 以 L1、L6 表現較佳，L4、L5 最弱。",
