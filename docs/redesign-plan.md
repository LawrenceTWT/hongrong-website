...
| about.html | Compact factual profile, experience, travel context, and résumé/certification archive; no duplicate long-form homepage story. |
...
- Footer, contact links, résumé link, and back-to-top.
...
- Existing project URLs, PDFs, and document links.
